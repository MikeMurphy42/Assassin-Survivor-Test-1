...
public class PlayerStatController : MonoBehaviour
{
    ...
    public void UpdateDisplay()
    {
        ...
        {
            UIController.instance.moveSpeedUpgradeDisplay.ShowMaxLVL();
        }
        ...
        {
            UIController.instance.healthUpgradeDisplay.ShowMaxLVL();
        }
        ...
        {
            UIController.instance.pickupRangeUpgradeDisplay.ShowMaxLVL();
        }
        ...
        {
            UIController.instance.maxWeaponsUpgradeDisplay.ShowMaxLVL();
        }
